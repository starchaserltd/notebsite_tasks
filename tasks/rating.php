...
$value=(0.60*$resrating+0.20*$sizerating+0.10*$touchratio+0.05*$surfaceratio+0.05*$ratiorating)*100;
...
if((stripos($stuff[$i][17],"jbl")!==FALSE)||(stripos($stuff[$i][17],"klipsch")!==FALSE)||(stripos($stuff[$i][17],"olufsen")!==FALSE)||(stripos($stuff[$i][17],"sonicmaster")!==FALSE))
{
	$rmsc[$id]+=2;
	$rmsc[$id]--;
}
